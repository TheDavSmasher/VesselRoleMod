...
{
	internal static ManualLogSource LocaleLogger { get; } = BepInEx.Logging.Logger.CreateLogSource("VesselModLocale");
	...
	public static void SearchInternalLocale()
	{
		...
		foreach (var locale in TouLocale.LangList)
		{
			...
			LocaleLogger.LogWarning($"Vessel Language is being added: {locale.Key.ToDisplayString()}");
